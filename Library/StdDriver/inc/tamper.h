...
#define TAMPER_2POW9_CLK           (0x3UL << TAMPER_TIOCTL_DYNRATE_Pos) /*!< 64 x 8 RTC clock cycles */
#define TAMPER_2POW10_CLK          (0x4UL << TAMPER_TIOCTL_DYNRATE_Pos) /*!< 64 x 16 RTC clock cycles */
#define TAMPER_2POW11_CLK          (0x5UL << TAMPER_TIOCTL_DYNRATE_Pos) /*!< 64 x 32 RTC clock cycles */
#define TAMPER_2POW12_CLK          (0x6UL << TAMPER_TIOCTL_DYNRATE_Pos) /*!< 64 x 64 RTC clock cycles */
#define TAMPER_2POW13_CLK          (0x7UL << TAMPER_TIOCTL_DYNRATE_Pos) /*!< 64 x 128 RTC clock cycles */
...
{
    if ((PMC->PLSTS & PMC_PLSTS_PLSTATUS_PL0) == PMC_PLSTS_PLSTATUS_PL0)
    {
        TAMPER->VG = (TAMPER->VG & ~0xFFFFUL) | 0x8CC8UL;
    }
    else if ((PMC->PLSTS & PMC_PLSTS_PLSTATUS_PL1) == PMC_PLSTS_PLSTATUS_PL1)
    {
        TAMPER->VG = (TAMPER->VG & ~0xFFFF0000UL) | 0x7CC90000UL;
    }
    else if ((PMC->PLSTS & PMC_PLSTS_PLSTATUS_PL2) == PMC_PLSTS_PLSTATUS_PL2)
    {
        TAMPER->VG2 = (TAMPER->VG2 & ~0xFFFFUL) | 0x5CCBUL;
    }
    else if ((PMC->PLSTS & PMC_PLSTS_PLSTATUS_PL3) == PMC_PLSTS_PLSTATUS_PL3)
    {
...
/**
  ...
  *
  */
#define TAMPER_GET_INT_FLAG()      ((TAMPER->INTSTS & (0x007707FF))? 1:0)
