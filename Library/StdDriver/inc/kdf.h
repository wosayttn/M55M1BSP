...
#define KDF_KEY_SIZE_128        (0x0UL)                         /*!< Key size 128 bits                  */
#define KDF_KEY_SIZE_163        (0x1UL)                         /*!< Key size 163 bits                  */
#define KDF_KEY_SIZE_192        (0x2UL)                         /*!< Key size 192 bits                  */
#define KDF_KEY_SIZE_224        (0x3UL)                         /*!< Key size 224 bits                  */
#define KDF_KEY_SIZE_233        (0x4UL)                         /*!< Key size 233 bits                  */
#define KDF_KEY_SIZE_255        (0x5UL)                         /*!< Key size 255 bits                  */
#define KDF_KEY_SIZE_256        (0x6UL)                         /*!< Key size 256 bits                  */
#define KDF_KEY_SIZE_283        (0x7UL)                         /*!< Key size 283 bits                  */
#define KDF_KEY_SIZE_384        (0x8UL)                         /*!< Key size 384 bits                  */
#define KDF_KEY_SIZE_409        (0x9UL)                         /*!< Key size 409 bits                  */
#define KDF_KEY_SIZE_512        (0xAUL)                         /*!< Key size 512 bits                  */
#define KDF_KEY_SIZE_521        (0xBUL)                         /*!< Key size 521 bits                  */
#define KDF_KEY_SIZE_571        (0xCUL)                         /*!< Key size 571 bits                  */

#define KDF_KEYIN_FROM_REG      (0UL << KDF_CTL_KEYINSEL_Pos)   /*!< KDF key input from register        */
#define KDF_KEYIN_FROM_KS_OTP   (1UL << KDF_CTL_KEYINSEL_Pos)   /*!< KDF key input from KS OTP Key 15   */
...
#define KDF_CTXT_FROM_REG       (0UL << KDF_CTL_CTXTSEL_Pos)    /*!< KDF context from register          */
#define KDF_CTXT_FROM_RANDOM    (1UL << KDF_CTL_CTXTSEL_Pos)    /*!< KDF context from random value      */
