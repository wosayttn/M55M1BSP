...
typedef struct
{
    ...
    __IO uint32_t UASSTR;                /*!< [0x002c] USB Asynchronous Schedule Sleep Timer Register                   */
    /// @cond HIDDEN_SYMBOLS
    __I  uint32_t RESERVE2[8];
    /// @endcond //HIDDEN_SYMBOLS
    __IO uint32_t UCFGR;                 /*!< [0x0050] USB Configure Flag Register                                      */
    __IO uint32_t UPSCR[2];              /*!< [0x0054] ~ [0x0068] USB Port 0 & 1 Status and Control Register                           */
    /// @cond HIDDEN_SYMBOLS
