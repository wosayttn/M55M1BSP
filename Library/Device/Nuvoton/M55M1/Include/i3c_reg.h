...
typedef struct
{
    ...
    __I  uint32_t RESERVE2[2];          /*!< [0x0064 ~ 0x0068] Reserved */
    ...
    __I  uint32_t RESERVE5[5];          /*!< [0x009c ~ 0x00ac] Reserved */
    ...
    __I  uint32_t RESERVE6[3];          /*!< [0x00c4 ~ 0x00cc] Reserved */
    ...
    __I  uint32_t RESERVE7[69];         /*!< [0x00ec ~ 0x01fc] Reserved */
    ...
    __I  uint32_t RESERVE8[4];          /*!< [0x0270 ~ 0x027c] Reserved */
...
#define I3C_RESPQUE_SLAVE_TID_Msk       (0x7UL << I3C_RESPQUE_TID_Pos)
#define I3C_RESPQUE_MASTER_TID_Msk      (0xFUL << I3C_RESPQUE_TID_Pos)
...
#define I3C_DATLEN(x)                   (((x) << I3C_CMDQUE_DATLEN_Pos) & I3C_CMDQUE_DATLEN_Msk)
#define I3C_DEVCOUNT(x)                 (((x) << I3C_CMDQUE_DEVCOUNT_Pos) & I3C_CMDQUE_DEVCOUNT_Msk)
