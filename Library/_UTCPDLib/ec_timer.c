...
/* Timer module for Chrome EC operating system */
    ...
    //#include "util.h"
    //#include "task.h"
    #include "ec_timer.h"//#include "timer.h"
    //#include "watchdog.h"
#else
    #include "utcpdlib.h"
#endif
...
#define __hw_clock_source_read()        __hw_clock_source_read64()
...
#ifdef SW      /* Due to didn't use process_timers() */
...
#ifdef SW        /* USBC PD seems not to use the function */
