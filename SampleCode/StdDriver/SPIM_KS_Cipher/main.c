...
int main()
{
    ...
    i32KeyIdx = KS_Write(eMemType, u32KeyMeta, gau32AESKey);
    ...
    /* Set Key form key store and protection region */
    OTFC_SetKeyFromKeyStore(OTFC0, OTFC_PR_0, TEST_BLOCK_ADDR, BUFFER_SIZE,
                            i32KeyIdx, OTFC_KS_SRC_SRAM);
