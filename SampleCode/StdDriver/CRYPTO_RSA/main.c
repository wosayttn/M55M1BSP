...
int32_t main(void)
{
   ...
   /* Unlock protected registers */
    ...
    if(RSA_Open(CRYPTO, RSA_MODE_NORMAL, RSA_KEY_SIZE_4096, &s_sRSABuf, sizeof(s_sRSABuf), 0) != 0)
    {
    ...
    /* Configure RSA operation mode and key length */
    if(RSA_Open(CRYPTO, RSA_MODE_NORMAL, RSA_KEY_SIZE_4096, &s_sRSABuf, sizeof(s_sRSABuf), 0))
    {
        printf("\nRSA buffer size is incorrect!!\n");
        return -1;
    }
