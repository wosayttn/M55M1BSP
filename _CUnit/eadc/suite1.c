...
void CU_S1T1_CONSTANT_EADC(void)
{
    ...
    CU_ASSERT_EQUAL(EADC_ACMP0_INT_TRIGGER, 0x220000);
    CU_ASSERT_EQUAL(EADC_ACMP1_INT_TRIGGER, 0x230000);
    CU_ASSERT_EQUAL(EADC_ACMP2_INT_TRIGGER, 0x240000);
    CU_ASSERT_EQUAL(EADC_ACMP3_INT_TRIGGER, 0x250000);
