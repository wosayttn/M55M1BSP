...
void CU_S1T1_CONSTANT_LPADC(void)
{
    ...
    CU_ASSERT_EQUAL(LPADC_ADCR_ADMD_BURST, 0x4);
    CU_ASSERT_EQUAL(LPADC_ADCR_ADMD_SINGLE_CYCLE, 0x8);
    CU_ASSERT_EQUAL(LPADC_ADCR_ADMD_CONTINUOUS, 0xC);
    
    CU_ASSERT_EQUAL(LPADC_ADCR_DMOF_UNSIGNED_OUTPUT,0x0);
    CU_ASSERT_EQUAL(LPADC_ADCR_DMOF_TWOS_COMPLEMENT,(0x1<<31));
    ...
    {
     CU_ASSERT_EQUAL(LPADC_ADCMPR_CMPMATCNT(u32TestCnt), ((u32TestCnt-1) << 8));
    }
    ...
    CU_ASSERT_EQUAL(LPADC_AUTOCTL_TRIGSEL_SOFTWARE, (0x0));
    CU_ASSERT_EQUAL(LPADC_AUTOCTL_TRIGSEL_LPTMR0, (0x0|(0x1 << 4)));
    CU_ASSERT_EQUAL(LPADC_AUTOCTL_TRIGSEL_LPTMR1, (0x1|(0x1 << 4)));
    CU_ASSERT_EQUAL(LPADC_AUTOCTL_TRIGSEL_TTMR0,  (0x2|(0x1 << 4)));
    CU_ASSERT_EQUAL(LPADC_AUTOCTL_TRIGSEL_TTMR1,  (0x3|(0x1 << 4)));
    CU_ASSERT_EQUAL(LPADC_AUTOCTL_TRIGSEL_WKIOA0, (0x4|(0x1 << 4)));
    CU_ASSERT_EQUAL(LPADC_AUTOCTL_TRIGSEL_WKIOB0, (0x5|(0x1 << 4)));
    CU_ASSERT_EQUAL(LPADC_AUTOCTL_TRIGSEL_WKIOC0, (0x6|(0x1 << 4)));
    CU_ASSERT_EQUAL(LPADC_AUTOCTL_TRIGSEL_WKIOD0, (0x7|(0x1 << 4)));
    CU_ASSERT_EQUAL(LPADC_AUTOCTL_TRIGSEL_ACMP0,  (0x8|(0x1 << 4)));
    CU_ASSERT_EQUAL(LPADC_AUTOCTL_TRIGSEL_ACMP1,  (0x9|(0x1 << 4)));
    CU_ASSERT_EQUAL(LPADC_AUTOCTL_TRIGSEL_ACMP2,  (0xA|(0x1 << 4)));
    CU_ASSERT_EQUAL(LPADC_AUTOCTL_TRIGSEL_ACMP3,  (0xB|(0x1 << 4)));
