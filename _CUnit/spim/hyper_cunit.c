...
void TrainingDllLatency()
{
    ...
    u32DMMAddr = SPIM_HYPER_GetDMMAddress(pSPIMModule);

    /* Erase HyperRAM */
    SPIM_EraseHyperRAM(pSPIMModule, u32SrcAddr, u32TestSize);

    /* Write Data to HyperRAM */
    for (u32i = u32SrcAddr; u32i < u32TestSize; u32i++)
    {
        u8TstBuf1[u32i] = (u32i + 0x01);
        SPIM_HYPER_Write1Byte(pSPIMModule, u32i, u8TstBuf1[u32i]);
    }
    ...
    for (u8RdDelay = 0; u8RdDelay <= SPIM_MAX_DLL_LATENCY; u8RdDelay++)
    {
        ...
        SPIM_HYPER_SetDLLDelayNum(pSPIMModule, u8RdDelay);

        /* Read Data from HyperRAM */
        SPIM_HYPER_DMARead(pSPIMModule, u32SrcAddr, u8TstBuf2, u32TestSize);
    ...
    SPIM_HYPER_ExitDirectMapMode(pSPIMModule);
    ...
    SPIM_HYPER_SetDLLDelayNum(pSPIMModule, u8RdDelayRes[u8RdDelayIdx]);
    CU_ASSERT(((pSPIMModule->DLL0 & SPIM_DLL0_DLL_DNUM_Msk) >> SPIM_DLL0_DLL_DNUM_Pos) == u8RdDelayRes[u8RdDelayIdx]);
...
{
    CU_ASSERT(HYPERRAM_ID_REG0 == (0x00000000));
    CU_ASSERT(HYPERRAM_ID_REG1 == (0x00000002));
    CU_ASSERT(HYPERRAM_CONFIG_REG0 == (0x00001000));
    CU_ASSERT(HYPERRAM_CONFIG_REG1 == (0x00001002));
}
...
void SPIM_Const_HYPER_CONFIG1()
{
    /*
        CSST
    */
    CU_ASSERT(SPIM_HYPER_CSST_2_5_HCLK == (0x1));
    CU_ASSERT(SPIM_HYPER_CSST_1_5_HCLK == (0x0));
    CU_ASSERT(SPIM_HYPER_CSST_3_5_HCLK == (0x2));
    CU_ASSERT(SPIM_HYPER_CSST_4_5_HCLK == (0x3));

    /*
        CSH
    */
    CU_ASSERT(SPIM_HYPER_CSH_0_5_HCLK == (0x0));
    CU_ASSERT(SPIM_HYPER_CSH_1_5_HCLK == (0x1));
    CU_ASSERT(SPIM_HYPER_CSH_2_5_HCLK == (0x2));
    CU_ASSERT(SPIM_HYPER_CSH_3_5_HCLK == (0x3));

    /*
        CSHI
    */
    CU_ASSERT(SPIM_HYPER_CSHI_2_HCLK == (0x02));
    CU_ASSERT(SPIM_HYPER_CSHI_3_HCLK == (0x03));
    CU_ASSERT(SPIM_HYPER_CSHI_4_HCLK == (0x04));
    CU_ASSERT(SPIM_HYPER_CSHI_5_HCLK == (0x05));
    CU_ASSERT(SPIM_HYPER_CSHI_6_HCLK == (0x06));
    CU_ASSERT(SPIM_HYPER_CSHI_7_HCLK == (0x07));
    CU_ASSERT(SPIM_HYPER_CSHI_8_HCLK == (0x08));
    CU_ASSERT(SPIM_HYPER_CSHI_9_HCLK == (0x09));
    CU_ASSERT(SPIM_HYPER_CSHI_10_HCLK == (0x0A));
    CU_ASSERT(SPIM_HYPER_CSHI_11_HCLK == (0x0B));
    CU_ASSERT(SPIM_HYPER_CSHI_12_HCLK == (0x0C));
    CU_ASSERT(SPIM_HYPER_CSHI_13_HCLK == (0x0D));
    CU_ASSERT(SPIM_HYPER_CSHI_14_HCLK == (0x0E));
    CU_ASSERT(SPIM_HYPER_CSHI_15_HCLK == (0x0F));
}
...
void MACRO_SPIM_HYPER_CONFIG1()
{
    ...
    SPIM_HYPER_SET_CSST(pSPIMModule, SPIM_HYPER_CSST_1_5_HCLK);
    CU_ASSERT(((pSPIMModule->HYPER_CONFIG1 & SPIM_HYPER_CONFIG1_CSST_Msk) >> SPIM_HYPER_CONFIG1_CSST_Pos) == SPIM_HYPER_CSST_1_5_HCLK);
    pSPIMModule->HYPER_CONFIG1 = 0;
    SPIM_HYPER_SET_CSST(pSPIMModule, SPIM_HYPER_CSST_2_5_HCLK);
    CU_ASSERT(((pSPIMModule->HYPER_CONFIG1 & SPIM_HYPER_CONFIG1_CSST_Msk) >> SPIM_HYPER_CONFIG1_CSST_Pos) == SPIM_HYPER_CSST_2_5_HCLK);
    pSPIMModule->HYPER_CONFIG1 = 0;
    SPIM_HYPER_SET_CSST(pSPIMModule, SPIM_HYPER_CSST_3_5_HCLK);
    CU_ASSERT(((pSPIMModule->HYPER_CONFIG1 & SPIM_HYPER_CONFIG1_CSST_Msk) >> SPIM_HYPER_CONFIG1_CSST_Pos) == SPIM_HYPER_CSST_3_5_HCLK);
    pSPIMModule->HYPER_CONFIG1 = 0;
    SPIM_HYPER_SET_CSST(pSPIMModule, SPIM_HYPER_CSST_4_5_HCLK);
    CU_ASSERT(((pSPIMModule->HYPER_CONFIG1 & SPIM_HYPER_CONFIG1_CSST_Msk) >> SPIM_HYPER_CONFIG1_CSST_Pos) == SPIM_HYPER_CSST_4_5_HCLK);

    /*
     *  SPIM_SET_HYPER_CONFIG1_CSH()
     */
    pSPIMModule->HYPER_CONFIG1 = 0;
    SPIM_HYPER_SET_CSH(pSPIMModule, SPIM_HYPER_CSH_0_5_HCLK);
    CU_ASSERT(((pSPIMModule->HYPER_CONFIG1 & SPIM_HYPER_CONFIG1_CSH_Msk) >> SPIM_HYPER_CONFIG1_CSH_Pos) == SPIM_HYPER_CSH_0_5_HCLK);
    pSPIMModule->HYPER_CONFIG1 = 0;
    SPIM_HYPER_SET_CSH(pSPIMModule, SPIM_HYPER_CSH_1_5_HCLK);
    CU_ASSERT(((pSPIMModule->HYPER_CONFIG1 & SPIM_HYPER_CONFIG1_CSH_Msk) >> SPIM_HYPER_CONFIG1_CSH_Pos) == SPIM_HYPER_CSH_1_5_HCLK);
    pSPIMModule->HYPER_CONFIG1 = 0;
    SPIM_HYPER_SET_CSH(pSPIMModule, SPIM_HYPER_CSH_2_5_HCLK);
    CU_ASSERT(((pSPIMModule->HYPER_CONFIG1 & SPIM_HYPER_CONFIG1_CSH_Msk) >> SPIM_HYPER_CONFIG1_CSH_Pos) == SPIM_HYPER_CSH_2_5_HCLK);
    pSPIMModule->HYPER_CONFIG1 = 0;
    SPIM_HYPER_SET_CSH(pSPIMModule, SPIM_HYPER_CSH_3_5_HCLK);
    CU_ASSERT(((pSPIMModule->HYPER_CONFIG1 & SPIM_HYPER_CONFIG1_CSH_Msk) >> SPIM_HYPER_CONFIG1_CSH_Pos) == SPIM_HYPER_CSH_3_5_HCLK);

    /*
     *  SPIM_SET_HYPER_CONFIG1_CSHI()
     */
    pSPIMModule->HYPER_CONFIG1 = 0;
    SPIM_HYPER_SET_CSHI(pSPIMModule, 2);
    CU_ASSERT(((pSPIMModule->HYPER_CONFIG1 & SPIM_HYPER_CONFIG1_CSHI_Msk) >> SPIM_HYPER_CONFIG1_CSHI_Pos) == 2);
    pSPIMModule->HYPER_CONFIG1 = 0;
    SPIM_HYPER_SET_CSHI(pSPIMModule, 7);
    CU_ASSERT(((pSPIMModule->HYPER_CONFIG1 & SPIM_HYPER_CONFIG1_CSHI_Msk) >> SPIM_HYPER_CONFIG1_CSHI_Pos) == 7);
    pSPIMModule->HYPER_CONFIG1 = 0;
    SPIM_HYPER_SET_CSHI(pSPIMModule, 12);
    CU_ASSERT(((pSPIMModule->HYPER_CONFIG1 & SPIM_HYPER_CONFIG1_CSHI_Msk) >> SPIM_HYPER_CONFIG1_CSHI_Pos) == 12);
    pSPIMModule->HYPER_CONFIG1 = 0;
    SPIM_HYPER_SET_CSHI(pSPIMModule, 15);
     ...
     */
    pSPIMModule->HYPER_CONFIG1 = 0;
    SPIM_HYPER_SET_CSMAXLT(pSPIMModule, 0x55AA);
    CU_ASSERT(SPIM_HYPER_GET_CSMAXLT(pSPIMModule) == 0x55AA);
    pSPIMModule->HYPER_CONFIG1 = 0;
    SPIM_HYPER_SET_CSMAXLT(pSPIMModule, 0xAA55);
    CU_ASSERT(SPIM_HYPER_GET_CSMAXLT(pSPIMModule) == 0xAA55);
...
void MACRO_SPIM_HYPER_CONFIG2()
{
    ...
    SPIM_HYPER_SET_ACCTWR(pSPIMModule, 0x1);
    CU_ASSERT(SPIM_HYPER_GET_ACCTWR(pSPIMModule) == 0x1);
    pSPIMModule->HYPER_CONFIG2 = 0;
    SPIM_HYPER_SET_ACCTWR(pSPIMModule, 0x1F);
    CU_ASSERT(SPIM_HYPER_GET_ACCTWR(pSPIMModule) == 0x1F);

    /*
     *  SPIM_SET_HYPER_CONFIG2_RSTNLT()
     */
    pSPIMModule->HYPER_CONFIG2 = 0;
    SPIM_HYPER_SET_RSTNLT(pSPIMModule, 0x10);
    CU_ASSERT(SPIM_HYPER_GET_RSTNLT(pSPIMModule) == 0x10);
    pSPIMModule->HYPER_CONFIG2 = 0;
    SPIM_HYPER_SET_RSTNLT(pSPIMModule, 0xC0);
    CU_ASSERT(SPIM_HYPER_GET_RSTNLT(pSPIMModule) == 0xC0);
    pSPIMModule->HYPER_CONFIG2 = 0;
    SPIM_HYPER_SET_RSTNLT(pSPIMModule, 0xFF);
    CU_ASSERT(SPIM_HYPER_GET_RSTNLT(pSPIMModule) == 0xFF);

    /*
     *  SPIM_SET_HYPER_CONFIG2_ACCTRD()
     */
    pSPIMModule->HYPER_CONFIG2 = 0;
    SPIM_HYPER_SET_ACCTRD(pSPIMModule, 0x1);
    CU_ASSERT(SPIM_HYPER_GET_ACCTRD(pSPIMModule) == 0x1);
    pSPIMModule->HYPER_CONFIG2 = 0;
    SPIM_HYPER_SET_ACCTRD(pSPIMModule, 0x1F);
    CU_ASSERT(SPIM_HYPER_GET_ACCTRD(pSPIMModule) == 0x1F);
