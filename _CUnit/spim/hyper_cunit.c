...
{
    CU_ASSERT(HYPER_CHIP_ID_REG0 == (0x00000000));
    CU_ASSERT(HYPER_CHIP_ID_REG1 == (0x00000002));
    CU_ASSERT(HYPER_CHIP_CONFIG_REG0 == (0x00001000));
    CU_ASSERT(HYPER_CHIP_CONFIG_REG1 == (0x00001002));
}

void SPIM_Const_HYPER_CMD()
{
    CU_ASSERT(SPIM_HYPER_CMD_HRAM_IDLE == (0x00000));
    CU_ASSERT(SPIM_HYPER_CMD_RESET_HRAM == (0x00001));
    CU_ASSERT(SPIM_HYPER_CMD_READ_HRAM_REGISTER == (0x00002));
    CU_ASSERT(SPIM_HYPER_CMD_EXIT_HS_PD == (0x00005));
    CU_ASSERT(SPIM_HYPER_CMD_WRITE_HRAM_REGISTER == (0x00007));
    CU_ASSERT(SPIM_HYPER_CMD_READ_HRAM_1_WORD == (0x00008));
    CU_ASSERT(SPIM_HYPER_CMD_READ_HRAM_2_WORD == (0x00009));
    CU_ASSERT(SPIM_HYPER_CMD_WRITE_HRAM_1_BYTE == (0x0000C));
    CU_ASSERT(SPIM_HYPER_CMD_WRITE_HRAM_2_BYTE == (0x0000D));
    CU_ASSERT(SPIM_HYPER_CMD_WRITE_HRAM_3_BYTE == (0x0000E));
    CU_ASSERT(SPIM_HYPER_CMD_WRITE_HRAM_4_BYTE == (0x0000F));
}
