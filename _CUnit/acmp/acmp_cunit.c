...
void API_ACM_Calibration()
{
    ...
    ACMP_Calibration(ACMP01);
    CU_ASSERT(ACMP01->CTL[0] == 0x10000011);
    CU_ASSERT(ACMP01->CTL[1] == 0x10000011);
    CU_ASSERT(ACMP01->STATUS == 0x00003033);
    CU_ASSERT(ACMP01->VREF   == 0x01400000);
    CU_ASSERT(ACMP01->CALCTL == 0x00000050);
    CU_ASSERT(ACMP01->CALSR == 0x00000011);
    ACMP_Calibration(ACMP23);
    CU_ASSERT(ACMP23->CTL[0] == 0x10000011);
    CU_ASSERT(ACMP23->CTL[1] == 0x10000011);
    CU_ASSERT(ACMP23->STATUS == 0x00003033);
    CU_ASSERT(ACMP23->VREF == 0x01400000);
    CU_ASSERT(ACMP23->CALCTL == 0x00000050);
    CU_ASSERT(ACMP23->CALSR == 0x00000011);
