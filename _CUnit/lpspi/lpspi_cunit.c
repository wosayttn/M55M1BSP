...
void MACRO_LPSPI_AUTO_MODE()
{
    ...
    LPSPI_SET_AUTO_TRIG_SOURCE(LPSPIModule, LPSPI_AUTOCTL_TRIGSEL_LPTMR0);
    CU_ASSERT(LPSPI_GET_AUTO_TRIG_SOURCE(LPSPIModule) == LPSPI_AUTOCTL_TRIGSEL_LPTMR0);
    LPSPI_SET_AUTO_TRIG_SOURCE(LPSPIModule, LPSPI_AUTOCTL_TRIGSEL_LPTMR1);
    CU_ASSERT(LPSPI_GET_AUTO_TRIG_SOURCE(LPSPIModule) == LPSPI_AUTOCTL_TRIGSEL_LPTMR1);
    LPSPI_SET_AUTO_TRIG_SOURCE(LPSPIModule, LPSPI_AUTOCTL_TRIGSEL_TTMR0);
    CU_ASSERT(LPSPI_GET_AUTO_TRIG_SOURCE(LPSPIModule) == LPSPI_AUTOCTL_TRIGSEL_TTMR0);
    LPSPI_SET_AUTO_TRIG_SOURCE(LPSPIModule, LPSPI_AUTOCTL_TRIGSEL_TTMR1);
    CU_ASSERT(LPSPI_GET_AUTO_TRIG_SOURCE(LPSPIModule) == LPSPI_AUTOCTL_TRIGSEL_TTMR1);
    LPSPI_SET_AUTO_TRIG_SOURCE(LPSPIModule, LPSPI_AUTOCTL_TRIGSEL_WKIOA);
    CU_ASSERT(LPSPI_GET_AUTO_TRIG_SOURCE(LPSPIModule) == LPSPI_AUTOCTL_TRIGSEL_WKIOA);
    LPSPI_SET_AUTO_TRIG_SOURCE(LPSPIModule, LPSPI_AUTOCTL_TRIGSEL_WKIOB);
    CU_ASSERT(LPSPI_GET_AUTO_TRIG_SOURCE(LPSPIModule) == LPSPI_AUTOCTL_TRIGSEL_WKIOB);
    LPSPI_SET_AUTO_TRIG_SOURCE(LPSPIModule, LPSPI_AUTOCTL_TRIGSEL_WKIOC);
    CU_ASSERT(LPSPI_GET_AUTO_TRIG_SOURCE(LPSPIModule) == LPSPI_AUTOCTL_TRIGSEL_WKIOC);
    LPSPI_SET_AUTO_TRIG_SOURCE(LPSPIModule, LPSPI_AUTOCTL_TRIGSEL_WKIOD);
    CU_ASSERT(LPSPI_GET_AUTO_TRIG_SOURCE(LPSPIModule) == LPSPI_AUTOCTL_TRIGSEL_WKIOD);

    LPSPI_ENABLE_AUTO_TRIG(LPSPIModule);
    CU_ASSERT_TRUE((LPSPIModule->AUTOCTL & LPSPI_AUTOCTL_TRIGEN_Msk) >> LPSPI_AUTOCTL_TRIGEN_Pos);

    LPSPI_DISABLE_AUTO_TRIG(LPSPIModule);
    CU_ASSERT_FALSE((LPSPIModule->AUTOCTL & LPSPI_AUTOCTL_TRIGEN_Msk) >> LPSPI_AUTOCTL_TRIGEN_Pos);

    LPSPI_ENABLE_AUTO_CNT_INT(LPSPIModule);
    CU_ASSERT_TRUE((LPSPIModule->AUTOCTL & LPSPI_AUTOCTL_CNTIEN_Msk) >> LPSPI_AUTOCTL_CNTIEN_Pos);

    LPSPI_DISABLE_AUTO_CNT_INT(LPSPIModule);
    CU_ASSERT_FALSE((LPSPIModule->AUTOCTL & LPSPI_AUTOCTL_CNTIEN_Msk) >> LPSPI_AUTOCTL_CNTIEN_Pos);

    LPSPI_ENABLE_AUTO_FULLRX(LPSPIModule);
    CU_ASSERT_TRUE((LPSPIModule->AUTOCTL & LPSPI_AUTOCTL_FULLRXEN_Msk) >> LPSPI_AUTOCTL_FULLRXEN_Pos);

    LPSPI_DISABLE_AUTO_FULLRX(LPSPIModule);
    CU_ASSERT_FALSE((LPSPIModule->AUTOCTL & LPSPI_AUTOCTL_FULLRXEN_Msk) >> LPSPI_AUTOCTL_FULLRXEN_Pos);

    LPSPI_ENABLE_SS_WAKEUP(LPSPIModule);
    CU_ASSERT_TRUE((LPSPIModule->AUTOCTL & LPSPI_AUTOCTL_SSWKEN_Msk) >> LPSPI_AUTOCTL_SSWKEN_Pos);

    LPSPI_DISABLE_SS_WAKEUP(LPSPIModule);
    CU_ASSERT_FALSE((LPSPIModule->AUTOCTL & LPSPI_AUTOCTL_SSWKEN_Msk) >> LPSPI_AUTOCTL_SSWKEN_Pos);

    LPSPI_ENABLE_AUTO(LPSPIModule);
    CU_ASSERT_TRUE((LPSPIModule->AUTOCTL & LPSPI_AUTOCTL_AUTOEN_Msk) >> LPSPI_AUTOCTL_AUTOEN_Pos);

    LPSPI_DISABLE_AUTO(LPSPIModule);
    ...
    LPSPI_DISABLE_AUTO_SW_TRIG(LPSPIModule);
    CU_ASSERT_FALSE((LPSPIModule->AUTOCTL & LPSPI_AUTOCTL_SWTRG_Msk) >> LPSPI_AUTOCTL_SWTRG_Pos);

    LPSPI_ENABLE_AUTO_CNT_WAKEUP(LPSPIModule);
    CU_ASSERT_TRUE((LPSPIModule->AUTOCTL & LPSPI_AUTOCTL_CNTWKEN_Msk) >> LPSPI_AUTOCTL_CNTWKEN_Pos);

    LPSPI_DISABLE_AUTO_CNT_WAKEUP(LPSPIModule);
    CU_ASSERT_FALSE((LPSPIModule->AUTOCTL & LPSPI_AUTOCTL_CNTWKEN_Msk) >> LPSPI_AUTOCTL_CNTWKEN_Pos);

    LPSPI_SET_AUTO_RX_TCNT(LPSPIModule, 1);
    CU_ASSERT(LPSPI_GET_AUTO_RX_TCNT(LPSPIModule) == 1);

    LPSPI_SET_AUTO_RX_TCNT(LPSPIModule, 0x1C);
    CU_ASSERT(LPSPI_GET_AUTO_RX_TCNT(LPSPIModule) == 0x1C);

    LPSPI_SET_AUTO_RX_TCNT(LPSPIModule, 0xFE);
    CU_ASSERT(LPSPI_GET_AUTO_RX_TCNT(LPSPIModule) == 0xFE);
...
void API_LPSPI_Open()
{
    ...
    CU_ASSERT(u32ReturnValue == 45000000);
...
void API_LPSPI_GetIntFlag_ClearIntFlag()
{
    ...
    CU_ASSERT(LPSPI_GetIntFlag(LPSPIModule, LPSPI_UNIT_INT_MASK) == 0);
    /* Reset SPI */
    LPSPI_ModuleReset(GetLPSPIModuleIdx());
    __NOP();
