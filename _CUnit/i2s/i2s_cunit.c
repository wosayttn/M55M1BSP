...
void ResetI2SModule(uint32_t u32I2SModule)
{
...
{
    uint32_t u32I2SIdx = 0;
    I2S_T *pI2SModule = NULL;

    for (u32I2SIdx = 0; u32I2SIdx < sizeof(g_apI2sModule) / sizeof(I2S_T *); u32I2SIdx++)
    {
        pI2SModule = (I2S_T *)GetI2SModuel(u32I2SIdx);
...
void API_I2S_Open()
{
    ...
    for (u32I2SIdx = 0; u32I2SIdx < sizeof(g_apI2sModule) / sizeof(I2S_T *); u32I2SIdx++)
    {
        ...
        else if (u32I2SIdx == C_I2S1)
        {
            CLK->I2SSEL = (CLK->I2SSEL & ~CLK_I2SSEL_I2S1SEL_Msk) | CLK_I2SSEL_I2S0SEL_HIRC;
        }
        ...
        CU_ASSERT(pI2SModule->CLKDIV == 0x00002D00);
        CU_ASSERT(u32ReturnValue == 8152);
        ...
        CU_ASSERT(pI2SModule->CLKDIV == 0x00001600);
        CU_ASSERT(u32ReturnValue == 8152);
        ...
        CU_ASSERT(pI2SModule->CLKDIV == 0x0000600);
        CU_ASSERT(u32ReturnValue == 17857);
        ...
        CU_ASSERT(pI2SModule->CLKDIV == 0x00000100);
        CU_ASSERT(u32ReturnValue == 46875);
